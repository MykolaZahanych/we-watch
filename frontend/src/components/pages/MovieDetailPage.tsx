        ...
        {showEditForm && (
          <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
            ...
            <div className='relative z-50 w-full max-w-3xl max-h-[90vh] overflow-y-auto bg-background rounded-lg shadow-lg border'>
              <MovieForm movie={movie} onSubmit={handleUpdate} onCancel={handleCancelEdit} />
            </div>
          </div>
        )}
          ...
          <Card>
            <CardContent className='p-6 space-y-6'>
              ...
              <div className='pt-4 border-t text-sm text-muted-foreground'>
                ...
                {movie.updatedAt !== movie.createdAt && <p>Updated: {new Date(movie.updatedAt).toLocaleString()}</p>}
              </div>
            </CardContent>
          </Card>
        )}
